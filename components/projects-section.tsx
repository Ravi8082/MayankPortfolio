...
import { ExternalLink, Lock, Database, Bot, Sparkles } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-6">
        ...
        {/* View link */}
        <div
          className="mt-5 flex items-center gap-2 text-sm font-medium text-primary transition-all duration-300"
          style={{
