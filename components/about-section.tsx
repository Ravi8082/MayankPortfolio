          ...
          >
            ...
            <div className="flex flex-wrap gap-6 mt-8">
              {[
                ...
                { value: 2025, suffix: "", label: "BCA Grad Year" },
              ].map((stat, i) => (
                <div
                  key={stat.label}
                  className={`card-3d flex-1 min-w-[120px] rounded-xl border border-border bg-card/30 p-5 text-center transition-all duration-500 ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-10"
                  }`}
                ...
                >
                  <p className="text-3xl font-bold text-primary neon-text mb-1">
                    <AnimatedCounter
                      target={stat.value}
                      suffix={stat.suffix}
                      isVisible={isVisible}
